...
"    }"));
        ...
        actionEraseDirectory = new QAction(InvestigationDirectoryWindow);
        actionEraseDirectory->setObjectName("actionEraseDirectory");
        QIcon icon7(QIcon::fromTheme(QIcon::ThemeIcon::EditDelete));
        actionEraseDirectory->setIcon(icon7);
        actionEraseDirectory->setMenuRole(QAction::MenuRole::NoRole);
        ...
        QFont font;
        font.setBold(true);
        TextLabelInvestigationsDirectory->setFont(font);
...
"}"));
        ...
        InvestigationsDirectoryTable->verticalHeader()->setVisible(false);

        verticalLayout->addWidget(InvestigationsDirectoryTable);

        SelectRowText = new QLabel(centralwidget);
        SelectRowText->setObjectName("SelectRowText");
        SelectRowText->setMinimumSize(QSize(0, 15));
        SelectRowText->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        SelectRowText->setStyleSheet(QString::fromUtf8("color: #707070;\n"
"font-size: 11px;"));
        SelectRowText->setMargin(0);
        SelectRowText->setIndent(9);

        verticalLayout->addWidget(SelectRowText);

        InvestigationDirectoryWindow->setCentralWidget(centralwidget);
        statusbar = new QStatusBar(InvestigationDirectoryWindow);
        statusbar->setObjectName("statusbar");
        statusbar->setMinimumSize(QSize(0, 10));
        ...
        toolBar->addSeparator();
        toolBar->addSeparator();
        toolBar->addAction(actionEraseDirectory);
    ...
    void retranslateUi(QMainWindow *InvestigationDirectoryWindow)
    {
        ...
        actionAddInvestigation->setText(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\224\320\276\320\261\320\260\320\262\320\270\321\202\321\214 \321\201\320\273\320\265\320\264\321\201\321\202\320\262\320\270\320\265", nullptr));
        actionDeleteInvestigation->setText(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214 \321\201\320\273\320\265\320\264\321\201\321\202\320\262\320\270\320\265", nullptr));
        ...
        actionFindInvestigationsByNumber->setText(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\237\320\276\320\270\321\201\320\272 \320\277\320\276 \320\275\320\276\320\274\320\265\321\200\321\203 \320\267\320\260\321\217\320\262\320\273\320\265\320\275\320\270\321\217", nullptr));
        actionFindInvestigationsByNumber->setIconText(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\237\320\276\320\270\321\201\320\272 \320\277\320\276 \320\275\320\276\320\274\320\265\321\200\321\203 \320\267\320\260\321\217\320\262\320\273\320\265\320\275\320\270\321\217", nullptr));
#if QT_CONFIG(tooltip)
        actionFindInvestigationsByNumber->setToolTip(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\237\320\276\320\270\321\201\320\272 \320\277\320\276 \320\275\320\276\320\274\320\265\321\200\321\203 \320\267\320\260\321\217\320\262\320\273\320\265\320\275\320\270\321\217", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        actionEraseDirectory->setText(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\236\321\202\321\207\320\270\321\201\321\202\320\270\321\202\321\214 \321\201\320\277\321\200\320\260\320\262\320\276\321\207\320\275\320\270\320\272 \321\201\320\273\320\265\320\264\321\201\321\202\320\262\320\270\320\271", nullptr));
#if QT_CONFIG(tooltip)
        actionEraseDirectory->setToolTip(QCoreApplication::translate("InvestigationDirectoryWindow", "\320\236\321\202\321\207\320\270\321\201\321\202\320\270\321\202\321\214 \321\201\320\277\321\200\320\260\320\262\320\276\321\207\320\275\320\270\320\272 \321\201\320\273\320\265\320\264\321\201\321\202\320\262\320\270\320\271", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        SelectRowText->setText(QCoreApplication::translate("InvestigationDirectoryWindow", "TextLabel", nullptr));
